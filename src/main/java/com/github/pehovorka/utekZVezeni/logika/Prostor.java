...
public class Prostor extends Observable {
	 ...
	 * @param hezkyNazev
	 *            Hezký název prostoru, může obsahovat i mezery.
	 * @param popis
	 *            Popis prostoru.
	 * @param x
	 *            souřadnice prostoru na ose x.
	 * @param y
	 *            souřadnice prostoru na ose y.
	 */
	 ...
	 * konstruktoru)
	 *
	 * @return text hezký název prostoru
	 */
	 ...
	 * 
	 * @param klic
	 *            - věc, která má sloužit, jako klíč k zamčenému prostoru
	 */
	...
	/**
	 * Vrací textový řetězec, který popisuje věci v místnosti, například: "věci:
	 * oběd ".
	 *
	...
	public Prostor vratSousedniProstor(String nazevSouseda) {
		...
		List<Prostor> hledaneProstory = vychody.stream().filter(sousedni -> sousedni.getNazev().equals(nazevSouseda))
	...
	/**
	 * Vrací názvy skrytých věcí v prostoru. Používá se po zadání příkazu
	 * prohledatMístnost. Nastavuje viditelnost skrytých věcí v místnosti na true.
	 * 
